...
const createSchema = (name, basepath) => {
  ...
  fs.writeFileSync(`${basepath}/models/schemas/${name}Schema.js`, template, 'utf-8')
...
const createCrud = async () => {
  try {
    ...
    console.log(chalk.blue(`Please import ${model}Routes.js into /routes/routes.js file`))
    console.log(chalk.blue(`Please modify ${cname}Schema.js and add the wanted field`))
  } catch (e) {
